...
def arg_parse():
    ...
    # args for train.py
    parser.add_argument('--experiment_dir', dest='experiment_dir',default="./output",
    ...
    parser.add_argument('--epoch', dest='epoch', type=int, default=40, help='number of epoch')
    ...
    parser.add_argument('--checkpoint_steps', dest='checkpoint_steps', type=int, default=100,
    ...
    # args for infer.py
    parser.add_argument('--model_dir', dest='model_dir',default=r"D:\code\calligraphy synthesis\CalliGAN\output\checkpoint\experiment_0_batch_16",
                        help='directory that saves the model checkpoints')
    parser.add_argument('--source_obj', dest='source_obj', type=str, default = r"D:\code\calligraphy synthesis\CalliGAN\output\data\cns_test.obj",help='the source images for inference')
    parser.add_argument('--embedding_ids', default='0',type=str, help='embeddings involved')
    parser.add_argument('--save_dir', default=r"D:\code\calligraphy synthesis\CalliGAN\output\sample", type=str, help='path to save inferred images')
